...
**Next:** persona-matrix synthetic models (PE/VC/RE/IB/corp-dev × skill level ×
seniority) generated by subagents, then simulated-journey scoring loops to find
where users stumble, iterating until the end-to-end benchmark passes.
