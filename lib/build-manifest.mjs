 ...
 * outputs (engine.js, sheets/, _ground-truth.json, manifest.json, and the
 * deterministic audit-lineage derivative when configured). The timestamped
...
export const ARTIFACTS = [
  ...
  { path: 'audit-lineage.json', role: 'audit-lineage', kind: 'file', required: false, identity: true },
