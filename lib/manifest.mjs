...
function detectCarry(gt, sheets) {
  ...
  // Pass 2: rank. Summary > rollup > generic > per-class; within a tier,
  // prefer non-zero values (a 0-value in a rollup is likely a restated copy
  // of an unpopulated column; picks from live formula columns win).
  candidates.sort((a, b) => {
