...
function detectCarry(gt, sheets) {
  ...
  for (const [addr, val] of Object.entries(gt)) {
    ...
    if (matchesCarryConcept && !isDisqualified) {
      ...
      // labelCol: carry totals are one cell — almost always adjacent to their
      // label, not in a time-series. Anchor the search to the label column so
      // the far-right restated copies can't win.
